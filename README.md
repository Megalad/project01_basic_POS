...
### Sales Journal
![Sales Journal Interface](./Screenshots/journal_page.png)
...
**Transaction History**
![History Table](./Screenshots/transaction_history.png)
*A clear list of all past sales with the ability to delete records.*

**Additional UI Design**
![UI Components](./Screenshots/additional_UI_design.png)
